...
export default function NotaCreditoList() {
  ...
  return (
    <div>
      <Toolbar title="Nota de cr?dito" count={rows.length} onNew={() => navigate("/va-notacredito/nuevo")} onExport={() => {}} />
      ...
      {preview && <DocumentPreviewModal title="Vista previa - Nota de Cr?dito" data={preview} fields={previewFields} onClose={() => setPreview(null)} />}
    </div>
  );
}
