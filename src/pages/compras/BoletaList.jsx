...
export default function BoletaCompraList() {
  ...
  return (
    <div>
      <Toolbar title="Compra - Boleta" count={rows.length} onNew={() => navigate("/c-boleta/nuevo")} onExport={() => {}} />
      ...
      {preview && <DocumentPreviewModal title="Vista previa - Boleta Compra" data={preview} fields={previewFields} onClose={() => setPreview(null)} />}
    </div>
  );
}
