...
export default function OrdenPagoList() {
  ...
  return (
    <div>
      <Toolbar title="Compra - Orden de Pago" count={rows.length} onNew={() => navigate("/c-orden/nuevo")} onExport={() => {}} />
      ...
      {preview && <DocumentPreviewModal title="Vista previa - Orden de Pago" data={preview} fields={previewFields} onClose={() => setPreview(null)} />}
    </div>
  );
}
